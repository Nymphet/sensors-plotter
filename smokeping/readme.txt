So to monitor if the network are working on a computer, the best way i can think of is to use smokeping.

this is just some example config files to make it working with nginx.
...
visit http://smokeping.example.com/ to see if everything is working.
